...
let newsCateogry = ['national', 'business', 'sports', 'world', 'politics', 'technology', 'startup', 'entertainment', 'hatke', 'science', 'automobile','miscellaneous'];
// Create XML Object
            ...
            for (key in data) {
                ...
                let news = `<div class="newsCard card">
                            ...
                            <div class="card-body">
                                ...
                                <a target="_blank" href="${data[key].readMoreUrl}" class="btn btn-danger">Read more..</a>
                            </div>
